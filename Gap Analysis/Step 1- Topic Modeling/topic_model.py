...
parser.add_argument("-save_model_dir", "--save_model_dir", default = '../result/saved_model/', type = str,
...
parser.add_argument("-save_performance", "--save_performance_dir", default = '../result/topic_performance/', type = str,
