...
parser.add_argument("-data1", "--data_source_one_directory", default = '/home/smriti/Desktop/NLP/MITACS/Anxiety/Data/Results/', type = str,
...
parser.add_argument("-data2", "--data_source_two_directory", default = '/home/smriti/Desktop/NLP/MITACS/Anxiety/Data/Results/', type = str,
                     help = "Read in results produced by topic modeling. All files in the dir would be read in and concat.")
...
source1_word_list = source1_df['Keywords'].tolist()
source2_word_list = source2_df['Keywords'].tolist()
joined_list = source1_word_list + source2_word_list


docs = []
print("Preparing data")
for Keywords in joined_list:
    docs.append(Keywords.split())
...
#pickle.dump(w2v_model, open('/home/smriti/Desktop/NLP/MITACS/Anxiety/Data/Results/w2v_model.sav', 'wb'))
#print("Download Completed")

#print("Saving model")
w2v_model = pickle.load(open('/home/smriti/Desktop/NLP/MITACS/Anxiety/Data/Results/w2v_model.sav', 'rb'))
