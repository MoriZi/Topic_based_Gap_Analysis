...
parser.add_argument("-long", "--long", default = '/home/smriti/Desktop/NLP/MITACS/GapAnalysis/long.csv', type = str,
                     help = "Read in long table.")

# directory to read source 1
parser.add_argument("-data1", "--data_source_one_directory", default = '/home/smriti/Desktop/NLP/MITACS/GapAnalysis/Academic/TMR/', type = str,
...
parser.add_argument("-data2", "--data_source_two_directory", default = '/home/smriti/Desktop/NLP/MITACS/GapAnalysis/NYT/TMR/', type = str,
                     help = "Read in results produced by topic modeling. All files in the dir would be read in and concat.")


# threshold of soft cosine measure to decide which topics are the the same topic
parser.add_argument("-threshold", "--threshold", default = .02, type = float,
                   help = "Two topics with soft cosine measure >= threshold would be considered as same topic.")


# directory to save results
parser.add_argument("-savedir", "--save_directory", default = '/home/smriti/Desktop/NLP/MITACS/GapAnalysis/', type = str,
